...
export default function ActiveProjects() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page, #07090F)" }}>
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[#141414] border border-[#222222] rounded-[10px] pl-10 pr-4 py-2.5 text-sm text-white placeholder-[#525252] focus:outline-none focus:border-[#6366F1] transition-colors"
            />
          </div>
        </div>
      )}
      ...
      {projects.length === 0 ? (
        <div className="text-center py-20 bg-[#111111] border border-[#2A2A2A] rounded-[12px]">
          ...
          <Link
            href="/projects/new"
            className="bg-[#6366F1] hover:bg-[#5254CC] text-[#F1F5F9] font-medium px-5 py-2.5 rounded-lg transition-colors inline-flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {projects.filter((p) => {
            ...
            return (
              <div
                key={project.id}
                className={`bg-[#111111] border border-[#2A2A2A] rounded-[12px] border-l-[3px] ${cardBorderColor} p-6 hover:bg-[#131729] transition-colors group relative`}
              >
                {/* Quick actions menu */}
                  ...
                  <div className="relative">
                    ...
                    {quickMenuId === project.id && (
                      <>
                        ...
                        <div className="absolute right-0 top-8 z-50 w-48 bg-[#111111] border border-[#2A2A2A] rounded-lg shadow-xl py-1">
                          <button
                            onClick={() => {
      ...
      {completeConfirmId && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={() => setCompleteConfirmId(null)}>
          <div className="bg-[#111111] border border-[#2A2A2A] rounded-xl p-6 max-w-sm w-full shadow-2xl" onClick={(e) => e.stopPropagation()}>
