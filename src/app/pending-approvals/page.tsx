  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page, #07090F)" }}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div className="bg-[#111111] border border-[#2A2A2A] rounded-[12px] p-5 flex items-center gap-4">
      ...
      <div className="mb-8">
        ...
        {pendingCRs.length === 0 ? (
          <div className="text-center py-16 bg-[#111111] border border-[#2A2A2A] rounded-[12px]">
          ...
          <div className="space-y-4">
            {pendingCRs.map(({ cr, project }) => (
              <div
                key={cr.id}
                className="bg-[#111111] border border-[rgba(99,102,241,0.15)] rounded-[12px] p-6 hover:bg-[#111111]/80 transition-colors"
              >
                ...
                <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-[#475569]">
                  <button
                    ...
                    className="bg-[#6366F1] hover:bg-[#5254CC] text-white font-medium px-4 py-2 rounded-lg text-xs transition-colors flex items-center gap-1.5"
                  >
      ...
      <div>
        ...
        <div className="text-center py-10 bg-[#111111] border border-[#2A2A2A] rounded-[12px]">
