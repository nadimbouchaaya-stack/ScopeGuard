  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page, #07090F)" }}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div className="bg-[#0F1322] border border-[rgba(255,255,255,0.06)] rounded-[14px] p-5 flex items-center gap-4">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-8 h-8 bg-[rgba(251,191,36,0.15)] rounded-lg flex items-center justify-center shrink-0">
        ...
        {pendingCRs.length === 0 ? (
          <div className="text-center py-16 bg-[#0F1322] border border-[rgba(255,255,255,0.06)] rounded-[14px]">
          ...
          <div className="space-y-4">
            {pendingCRs.map(({ cr, project }) => (
              <div
                key={cr.id}
                className="bg-[#0F1322] border border-[rgba(99,102,241,0.15)] rounded-[14px] p-6 hover:bg-[#0F1322]/80 transition-colors"
              >
                ...
                <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-[#475569]">
                  <button
                    ...
                    className="bg-[#6366F1] hover:bg-[#5558E6] text-white font-medium px-4 py-2 rounded-lg text-xs transition-colors flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="bg-[rgba(239,68,68,0.15)] text-[#FCA5A5] border border-[rgba(239,68,68,0.3)] font-medium px-4 py-2 rounded-lg text-xs transition-colors flex items-center gap-1.5"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
      ...
      <div>
        ...
        <div className="text-center py-10 bg-[#0F1322] border border-[rgba(255,255,255,0.06)] rounded-[14px]">
