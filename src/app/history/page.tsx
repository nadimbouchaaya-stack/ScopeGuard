    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--bg-page, #07090F)" }}>
      ...
      {clientNames.length === 0 ? (
        <div className="text-center py-20 bg-[#111111] border border-[#2A2A2A] rounded-[12px]">
          ...
          <Link
            href="/projects"
            className="inline-flex items-center gap-2 bg-[#6366F1] hover:bg-[#5254CC] text-[#F1F5F9] font-medium px-5 py-2.5 rounded-lg transition-colors text-sm"
          >
        ...
        <div className="space-y-8">
          {clientNames.map((clientName) => {
            ...
            return (
              <div key={clientName} className="bg-[#111111] border border-[#2A2A2A] rounded-[12px] overflow-hidden">
