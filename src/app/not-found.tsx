...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center px-4">
      <div className="bg-[#111111] border border-[#2A2A2A] rounded-2xl p-8 sm:p-12 text-center max-w-md w-full">
        ...
        <Link
          href="/dashboard"
          className="inline-block bg-[#6366F1] hover:bg-[#5254CC] text-white font-semibold px-8 py-3 rounded-xl transition-all hover:scale-105 text-sm"
        >
          Go to Dashboard
        </Link>
      </div>
